...
m:section(SimpleSection).template  = "adkplock/adbyby_status"
...
o.description = string.format("<strong>检查上次更新：</strong> %s<br /><strong>Lazy 规则：</strong>%s <br /><strong>视频规则：</strong>%s<br /><strong>第三方订阅规则：</strong>%d 条<br /><strong>用户自定义规则：</strong>%d 条", UD, DL, DV, math.abs(NR-NU), NR) 
o.inputstyle = "reload"
o.write = function()
