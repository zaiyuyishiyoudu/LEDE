...
o:section(SimpleSection).template  = "adkplock/koolproxy_status "
...
e.write = function()
	...
	luci.http.redirect(luci.dispatcher.build_url("admin","services","adkplock","koolproxy"))
end
...
e.template="adkplock/caupload"
e=t:taboption("cert",DummyValue,"",nil)
e.template="adkplock/cadvalue"
...
t.sortable=true
t.template="cbi/tblsection"
t.extedit=luci.dispatcher.build_url("admin/services/adkplock/rss_rule/%s")
