...
local function get_status()
	if nixio.fs.access("/etc/config/wifidogx") then


		return translate("<span id=\"wifidog-status\">1</span><br /><br /><span id=\"version-status\">软件版本:</span><br /><br /><span id=\"internet-status\">互联网状态:</span><br /><br /><span id=\"auth-status\">认证服务器状态:</span>")
	end
...
-- 高级设置
WiredPass = s:taboption("advanced", Flag, "wired_passed", translate("有线免认证"), translate("不影响有线连接"))
...
m:section(SimpleSection).template = "wifidogx/client_list"
